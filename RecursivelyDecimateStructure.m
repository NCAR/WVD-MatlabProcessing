...
CellDataNew = RecursiveDecimateData(Cell,DecimateTime,OriginalSizeTime,DecimateSpace,OriginalSizeSpace);
...
% recursively
function [CellDataNew] = RecursiveDecimateData(CellData,DecimateTime,OriginalSizeTime,DecimateSpace,OriginalSizeSpace) 
%                        
% Inputs: CellData:      
%         Fill:     
%                        
...
for m=1:1:size(CellData,1)
   if iscell(CellData{m,1}) 
       ...
       Temp = RecursiveDecimateData(CellData{m,1},DecimateTime,OriginalSizeTime,DecimateSpace,OriginalSizeSpace);
