...
function [Counts,DataProducts] = RetrievalsH2O(Altitude,Counts,DataProducts,JSondeData,Map,Options,Paths,PulseInfo,PulseInfoNew,SpatialAverage,SurfaceWeather,AverageRange)
%
%
%
%
...
if Options.Process.WVPCA == 1
    for m=1:1:2
       switch m
           case 1; Map2Use = Map.Online;
           case 2; Map2Use = Map.Offline;
       end
        [DataProducts.Sigma{Map2Use,1}] =                                  ...
              PCASpectralLineFittingWV(Options.flag,                       ...
                                       PulseInfo.LambdaUnique{Map2Use,1},  ...
                                       PulseInfo.LambdaNearest{Map2Use,1}, ...
                                       H2OPCATrainingSet,                  ...
                                       Counts.CountRate{Map2Use,1},        ...
    ...
    for m=1:1:2
        ...
        [DataProducts.Sigma{Map2Use,1}] =                                  ...
                 SpectralLineFittingWV(Options.flag,                       ...
                                       PulseInfo.LambdaUnique{Map2Use,1},  ...
                                       PulseInfo.LambdaNearest{Map2Use,1}, ...
                                       H2OPCATrainingSet,                  ...
                                       Counts.CountRate{Map2Use,1},        ...
...
[DataProducts.N,DataProducts.N_Error] =  ...
    DIALEquationNarrowlySpaced(Counts.CountRate{Map.Online,1},     ...
                               Counts.BackgroundSubtracted{Map.Online,1},    ...
                               Counts.CountRate{Map.Offline,1},    ...
                               Counts.BackgroundSubtracted{Map.Offline,1},   ...
                               ...
                               PulseInfo.BinWidth.*PulseInfo.DeltaRIndex);
...
% Determining the offline count rate in Hz
CountRateObserved = Counts.Parsed{Map.Offline,1}./(PulseInfoNew.Data.RangeResolution{Map.Offline,1}.*1e-9.*PulseInfoNew.Data.ProfilesPerHistogram{Map.Offline,1});
CountRateObserved = interp1(PulseInfo.DataTimeRaw,CountRateObserved,PulseInfo.DataTime,Options.InterpMethod,Options.Extrapolation);
% Applying masks
