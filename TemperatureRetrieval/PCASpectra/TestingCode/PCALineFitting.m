...
function [CrossSection,A] = PCALineFitting(TrainingSet,PressRebuild,TempRebuild,WavelengthsDesired)
%
...
A = Rebuild(TrainingSet.MeanSpectrum, ...
...
%% Linearly interpolating absorption at exact pt(s)
CrossSection = interp1(TrainingSet.Lambda,A,WavelengthsDesired)';
end
