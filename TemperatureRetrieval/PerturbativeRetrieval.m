...
Pt.Order0 = CalculateAlpha0(Counts.BGSub.O2Online.Counts,               ...
                            ...
                            Options.BinRange,                           ...
                            Data2D.NCIP.Pressure.Value,                 ...
                            Data2D.NCIP.Temperature.Value,              ...
                            Data2D.MPD.Humidity.Value,Constants,        ...
                            Options,Spectra.Rebuilt);
CWLogging(['  Calculating: Alpha0 took: ',num2str(toc),' [sec] \n'],Op,'Retrievals')
%% First order retrieval
tic
Pt.Order1 = CalculateAlpha1(Pt.Order0,Spectra,Data2D.MPD.BackRatio.Value, ...
                                          Options.BinRange,Options.Range');                                
